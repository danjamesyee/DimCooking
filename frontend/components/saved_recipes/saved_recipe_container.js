...
import { fetchSavedRecipes, deleteSavedRecipe } from '../../actions/saved_recipe_actions';
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SavedRecipePage));
