...
#         steam the shrimp dumplings for 6 minutes using high heat and serve hot. 
#         Make sure that they each have an inch and a half to expand during the cooking process.'], 
#     author_id: User.find_by(username: 'gilbert12').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/hargow.jpg"), filename: 'hargow.jpg')
...
recipe2 = Recipe.create(
    ...
    author_id: User.find_by(username: 'thedaniel').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/nomaigai.jpg"), filename: 'nomaigai.jpg')
...
recipe3 = Recipe.create(
    ...
    author_id: User.find_by(username: 'thedaniel').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/chasiubau.jpeg"), filename: 'chasiubau.jpg')
...
recipe4 = Recipe.create(
    ...
    author_id: User.find_by(username: 'thedaniel').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/lobakgo.jpg"), filename: 'lobakgo.jpg')
...
recipe5 = Recipe.create(
    ...
    author_id: User.find_by(username: 'thedaniel').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/siumai.jpeg"), filename: 'siumai.jpg')
...
recipe6 = Recipe.create(
    ...
    author_id: User.find_by(username: 'thedaniel').id).photo.attach(io: File.open("/Users/danielyee/AppAcademy/dimcooking/app/assets/images/teochew.jpeg"), filename: 'teochew.jpg')
